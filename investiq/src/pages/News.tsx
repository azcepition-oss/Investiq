...
export const News = () => {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        const prompt = `Provide a comprehensive rundown of the top 6 major market-moving news events from the last 7 days. 
        For each event, provide:
        1. A short, punchy title.
        2. A 1-sentence summary of WHAT happened and WHY it triggered the market.
        3. A deeper elaboration (2-3 sentences) explaining the context.
        4. The overall market sentiment (up, down, or neutral).
        5. A credible source name and a realistic URL.
        6. A category (e.g., "Tech", "Economy", "Global", "Energy").
        
        Format the response as a JSON array of objects with keys: title, summary, elaboration, sentiment, source, sourceUrl, category.
        Tone: Professional news outlet, direct, high energy.`;
